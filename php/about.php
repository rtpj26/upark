	...
	<body>
		<div class="container">
			...
			<ul class="page-content">
				<li>
					<div class="whitebg justify" style="padding: 20px;">
						<p style="font-size: 200%;">ABOUT UPARK SYSTEM</p>
						<p style="font-size: 150%;">Something about a very long text that's full of lorem ipsum</p>
						<br>
						...
						<p style="font-size: 150%;"><strong>LATEST FEEDS:</strong></p>
						<div class="row text-center">
							<div class="col-md-4" style="padding:20px;">
								<img src="../img/feed1.png"/><br>
								<p>FEED #1</p><br>
				...
				<li>
					<div class="blackbg" style="padding:50px; padding-top: 20px;">
						<span style="font-size: 200%">USLS PARK SYSTEM</span><br>
						<span class="text-justify">Lorem ipsum dolor sit amet, consectetur 
						adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore 
						magna aliqua. Ut enim ad minim veniam</span>
						<br><br>
						<span style="float:right;"><a href="" style=" color:#009e3d;">READ MORE</a></span>
					</div>
				</li>
				<li>
