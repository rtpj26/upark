				...
				<li>
					<div class="whitebg text-center">
						...
						<div class="row" style="margin-top:50px; margin-bottom: 50px;">
							...
							<div class="col-md-3">
								<a href="application_RN.php"><button class="btn btn-default blackbg" style="padding-top: 50px; padding-bottom: 50px;">CAR STICKER APPLICATION</button></a>
							</div>
							<div class="col-md-3">
								<a href="enter_sticker.php"><button class="btn btn-default blackbg" style="padding-top: 50px; padding-bottom: 50px;">ENTER STICKER NUMBER</button></a>
							</div>
							<div class="col-md-3"></div>
						</div>
					</div>
