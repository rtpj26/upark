	...
	<body>
		<div class="container">
			...
			<ul class="page-content">
				...
				<li>
					<div class="greenbg text-center" style="margin-top:-50px;">
						...
						<ul class="spaced text-center inlinelist" style="padding-bottom: 20px; margin-top: 20px;">
							<li class="inlineli"><a href="index.php" style="color: #fff;">HOME</a></li>
							<li class="inlineli"><a href="index.php" style="color: #fff;">ABOUT</a></li>
							<li class="inlineli"><a href="index.php" style="color: #fff;">ADMIN</a></li>
							<li class="inlineli"><a href="index.php" style="color: #fff;">UPDATES</a></li>
							<li class="inlineli"><a href="index.php" style="color: #fff;">NEWS</a></li>
							<li class="inlineli"><a href="index.php" style="color: #fff;">CONTACT</a></li>
							<li class="inlineli"><a href="index.php" style="color: #fff;">FORMS</a></li>
						</ul>
					</div>
				</li>
				<!--Footer-->
