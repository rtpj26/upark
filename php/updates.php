	...
	<body>
		<div class="container">
			...
			<ul class="page-content">
				<li>
					<div class="whitebg">
						<p style="font-size: 200%; padding-top: 50px;">View <strong>Park Updates</strong></p>
						<img src="../img/updates_stripes.png"/ width="300" height="50" style="padding-bottom:25px;">
						<br>
						<div class="row text-center">
							<div class="col-md-3" style="padding:10px;">
								<img src="../img/frames.png" />
								<p>Lorem ipsum dolor<br>Sit amet nah gar<br>sii defar cvbuqp<br></p>
								<p style="color: #009e3d">READ MORE</p>
							</div>
							<div class="col-md-3" style="padding:10px;">
								<img src="../img/frames.png" />
								<p>Lorem ipsum dolor<br>Sit amet nah gar<br>sii defar cvbuqp<br></p>
