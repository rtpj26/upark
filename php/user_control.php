			...
			<ul class="page-content">
				<li>
					<div class="whitebg text-center">
						...
						<img src="../img/lasalle.png" width="700" height="600"/>
						<br>
						<strong style="font-size: 300%; margin-top:20px;">WELCOME</strong>
						<div class="row" style="margin-top:50px; margin-bottom: 50px;">
							<div class="col-md-3"></div>
							<div class="col-md-3">
								<button class="btn btn-default blackbg" style="padding-top: 50px; padding-bottom: 50px;">CHECK AVAILABLE<br>PARKING SLOTS</button>
							</div>
							<div class="col-md-3">
								<button class="btn btn-default blackbg" style="padding-top: 50px; padding-bottom: 50px;">VIEW USER<br>INFORMATION</button>
							</div>
							<div class="col-md-3"></div>
						</div>
					</div>
